...
public class ClienteEntity {
	...
	public boolean equals(Object o) {
		...
		return idCliente == that.idCliente && Double.compare(that.dinero, dinero) == 0 && idBanco == that.idBanco
				&& Objects.equals(nombreLegal, that.nombreLegal) && Objects.equals(direccionLegal, that.direccionLegal)
	...
	public String toString() {
		return "idCliente=" + idCliente + "&nombreLegal=" + nombreLegal + "&direccionLegal=" + direccionLegal
				+ "&dinero=" + dinero + "&email=" + email + "&idBanco=" + idBanco;
	}
}
