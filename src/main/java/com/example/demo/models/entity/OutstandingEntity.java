...
public class OutstandingEntity {
	...
	public boolean equals(Object o) {
		...
		return idOutstanding == that.idOutstanding && Double.compare(that.cantidadRestante, cantidadRestante) == 0
				&& Double.compare(that.pagoPrincipal, pagoPrincipal) == 0
				&& Double.compare(that.pagoIntereses, pagoIntereses) == 0 && tipoInteres == that.tipoInteres
				&& Double.compare(that.cantidadCobroPeriodico, cantidadCobroPeriodico) == 0 && facility == that.facility
				&& Objects.equals(fechaEfectiva, that.fechaEfectiva)
				&& Objects.equals(fechaCreacion, that.fechaCreacion)
				&& Objects.equals(fechaFinalizacion, that.fechaFinalizacion)
				&& Objects.equals(tipoCobros, that.tipoCobros) && Objects.equals(periodicidad, that.periodicidad);
	}

	@Override
	public int hashCode() {
		return Objects.hash(idOutstanding, cantidadRestante, fechaEfectiva, fechaCreacion, fechaFinalizacion,
