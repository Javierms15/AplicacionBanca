...
public class ParticipanteEntity {
	...
	public boolean equals(Object o) {
		...
		return idParticipante == that.idParticipante && idBanco == that.idBanco && idDeal == that.idDeal
				&& Double.compare(that.porcentajeParticipacion, porcentajeParticipacion) == 0 && agente == that.agente;
	}
