...
public class DealEntity {
    ...
    public boolean equals(Object o) {
        ...
        return idDeal == that.idDeal && Double.compare(that.cantidadPrestamo, cantidadPrestamo) == 0 && Double.compare(that.cantidadAbonada, cantidadAbonada) == 0 && Double.compare(that.cantidadAPagar, cantidadAPagar) == 0 && descuento == that.descuento && cliente == that.cliente && Objects.equals(estado, that.estado) && Objects.equals(moneda, that.moneda) && Objects.equals(tipo, that.tipo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idDeal, estado, cantidadPrestamo, cantidadAbonada, cantidadAPagar, moneda, tipo, descuento, cliente);
    }
}
